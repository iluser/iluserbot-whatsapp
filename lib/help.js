...
› ${prefix}ig3 https://www.instagram.com/p/B5yrmkKBFID/
...
*${prefix}randomkiss* : random gambar anime ciuman
...
1. Akses limit yang tak terbatas
2. Bisa memasukkan bot ke dalam grup hanya dengan perintah ${[prefix]}join
3. Akses seluruh fitur yang tersedia di dalam bot
4. Masa aktif 31 hari
5. Full support dari develper bot
6. Daftar pertama 15k/bulan
7. Biaya perpanjang 10k/bulan

Yok gan support develover bot dengan cara upgrade menjadi user premium. Kamu dapat melihat info pembayaran melalui command *${prefix}donasi*
`
}
